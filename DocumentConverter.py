...
#
# Modified by Lars Strand to add support for xml and wiki filters
#
...
EXPORT_FILTER_MAP = {
    "xml": {
        ...
        FAMILY_WEB: { "FilterName": "XHTML Writer File" },
    },
    "wiki": {
        FAMILY_TEXT: { "FilterName": "MediaWiki" },
        FAMILY_WEB: { "FilterName": "MediaWiki" },
    },
    "pdf": {
